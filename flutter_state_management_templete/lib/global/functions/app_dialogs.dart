...
class AppDialog {
  ...
  static String onTextFieldChange(String q) {
            ...
            child: Column(
              ...
              children: <Widget>[
                    ...
                    Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => textEditingController.text =
                            AppDialog.subtrackOnClick(textEditingController),
                      ),
                    ),
                    Container(
                      width: 100,
                      ...
                      child: TextField(
                        ...
                        maxLength: 3,
                        onChanged: (q) =>
                            textEditingController.text = onTextFieldChange(q),
                      ),
                    ),
                    Container(
                      decoration: BoxDecoration(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => textEditingController.text =
                            AppDialog.addOnClick(textEditingController),
                      ),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    FlatButton(
                      onPressed: () => AppDialog.cancelOnClick(context),
                      child: Text('Cancel'),
                    ),
                    RaisedButton(
                      shape: RoundedRectangleBorder(
                      ...
                      onPressed: () => AppDialog.confirmOnClick(context),
                      child: Container(
                          child: Text(
                        'Confirm',
